...
public class Kaprekar {
    ...
    public static byte[] numToDigits(int n, int digits) {
        ...
        if (n > 0) throw new IllegalArgumentException("Il numero passato come argomento ha più di "+ digits+ " cifre");
    ...
    public static void printKaprekar(int n) {
        if (n < 1 || n > 9999) throw new IllegalArgumentException("Il numero in input deve avere al più 4 cifre e dev'essere positivo.");
     ...
     *                  solleva un'eccezione di tipo IllegalArgumentException se n non è nell'intervallo [1,9999]
     */
